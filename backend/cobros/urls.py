...
router.register(r'cuotas/infante/(?P<id_infante>\d+)', CuotasPorInfanteView, basename='cuotas-por-infante')
router.register(r'cuotas/cobrar', CobroCuotaView, basename='cobro-cuota')
router.register(r'infantes/listar', ListarInfantesView, basename='listar-infantes')
