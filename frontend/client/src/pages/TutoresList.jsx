...
export default function ListaTutores() {
  ...
  const columnas = [
    ...
    },
    {
      ...
      cell: (row) => (
        <button
          onClick={() => navigate(`/tutores/${row.id}`)}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-blue-600">Listado general de tutores del sistema</p>
          </div>
          {puedeEscribir && (
            <button 
          ...
          <DataTable
            ...
            noDataComponent={
              <div className="p-8 text-center text-blue-600">
                ...
                <h3 className="mt-2 text-sm font-medium text-blue-800">🚫 No hay tutores</h3>
                <p className="mt-1 text-sm text-blue-600 mb-4">Actualmente no se registraron tutores en el sistema</p>
                {puedeEscribir && (
                  <button
                    onClick={() => navigate("/tutores-crear")}
